...
def main():
    ...
    if (
        config["analysis"]["calculate_ndvi"]
        and config["analysis"]["red_band"] in df.columns
        and config["analysis"]["nir_band"] in df.columns
    ):
        ndvi = calculate_ndvi(
            df, config["analysis"]["red_band"], config["analysis"]["nir_band"]
        )
